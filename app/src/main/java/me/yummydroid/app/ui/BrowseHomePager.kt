...
private data class BrowsePagerPresentation(
...
@Composable
private fun rememberBrowsePagerPresentation(
    active: Boolean,
    effectiveSection: BrowseSection,
    pagerSections: List<BrowseSection>,
    pagerPage: Int,
...
@Composable
private fun BrowsePagerSectionFocusEffect(
    effectiveSection: BrowseSection,
    usePager: Boolean,
    dpadFocusEnabled: Boolean,
    runtime: BrowsePagerRuntime,
...
@Composable
private fun BrowseHomeBackStateEffect(
    active: Boolean,
    effectiveSection: BrowseSection,
    pagerSections: List<BrowseSection>,
    pagerPage: Int,
